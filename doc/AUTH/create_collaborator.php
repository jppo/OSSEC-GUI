...
{ 
	try {
    $auth->admin()->addRoleForUserByUsername($usern, \Delight\Auth\Role::COLLABORATOR);
	$MSG2 = " Assigned to role EDITOR";
	} catch (\Delight\Auth\UnknownUsernameException $e) {
    // unknown username
		$MSG2 = "Can't assign user to role COLLABORATOR, unknown user";
		$ERR = 4;
